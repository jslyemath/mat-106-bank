...
def run_D3():
    ...
    print(f'Orig Frac: {orig_frac}\n')
    print(f'Orig Dec: {orig_frac_dec}\n')
    print(f'Orig Dec Trun: {orig_frac_dec_str}\n')
    ...
    print(f'Transposes: {transposeds}\n')
    ...
    print(f'Benchmark Fracs: {bench_fracs}\n')
